...
class TestGridSimulator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.battery_simulator = BatterySimulator(battery_soc = 0.5, battery_capacity  = 1000, battery_C_rate  = 0.2, battery_efficiency  = 0.9, battery_soc_cuttoff   = 0.4, time_interval  = 1)
    ...
    def test_charge(self):
        ...
        self.assertEqual(excess, charge_energy-(charged/self.battery_simulator.battery_efficiency))
