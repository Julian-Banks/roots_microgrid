...
class GridFeedInSimulator():
    def __init__(self,feed_in_voltage:float = 240, feed_in_power_rating:float = 1000,take_off_voltage:float= 240, take_off_power_rating:float = 1000, transformer_efficiencies:float = 1):
